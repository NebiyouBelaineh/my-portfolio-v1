...
const aboutme = () => {
  return (
    <div className='bg-base-300 py-16 md:p-20 flex'>
      ...
      <div className=''>
      <Image src="/images/Nebiyou_Belaineh.jpg" alt="Nebiyou_Belaineh" width={400} height={400} className="w-1/2 mx-4"></Image>
      </div>
    </div>
  )
}
